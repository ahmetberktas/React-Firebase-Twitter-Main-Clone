...
import { FollowUsers } from "../constants/FollowUsers";
        ...
        <div className="grid">
          {FollowUsers.map((user, index) => (
            ...
            >
              ...
              <div>
                <button className="bg-[#eff3f4] hover:bg-[#d7dbdc] text-black text-sm font-bold px-4 rounded-full h-8">
                  Takip et
                </button>
              </div>
            </button>
